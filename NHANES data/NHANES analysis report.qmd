...
# Load results
res_mvs_default <- readRDS('Initial results/res_mvs_default.rds')

# res_mvs_rf <- readRDS('Initial results/res_mvs_rf.rds')

res_mvs_resid <- readRDS('Initial results/res_mvs_resid.rds')
